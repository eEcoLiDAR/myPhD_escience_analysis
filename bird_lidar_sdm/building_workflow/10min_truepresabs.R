...
for (bird_species in species) {
  ...
  p6
  ggsave(paste(bird_species,'_10mincount_nl.jpg',sep=''),p6)
  
  # Export
  write.csv(observationmap, file = paste(bird_species,'_10mincount_nl.csv',sep=''),row.names=FALSE)
}
...
ggsave(paste('10minstat.jpg',sep=''),p1)
...
ggsave(paste('10minstat_pyear.jpg',sep=''),p2)
