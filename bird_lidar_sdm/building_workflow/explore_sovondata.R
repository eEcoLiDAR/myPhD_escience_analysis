...
bird_groupby=ddply(bird_data_onebird_onlypres,~kmsquare+x+y+present+species,summarise,sum=sum(number))
...
#Presence-absence
observationmap=ddply(bird_data_onebird,~kmsquare+x+y+species,summarise,sum=sum(number))
