...
write.csv(tocsv_t,file="conf_m_level3.csv")

tocsv_oa <- data.frame(conf_m$overall)
write.csv(tocsv_oa,file="acc_oa_level3.csv")

tocsv_cl <- data.frame(conf_m$byClass)
write.csv(tocsv_cl,file="acc_byclass_level3.csv")
...
writeRaster(level1_reg1_prob_class1, filename="classified_prob_class1_reg1_lev3.tif", format="GTiff",overwrite=TRUE)
writeRaster(level1_reg1_prob_class2, filename="classified_prob_class2_reg1_lev3.tif", format="GTiff",overwrite=TRUE)
writeRaster(level1_reg1_prob_class3, filename="classified_prob_class3_reg1_lev3.tif", format="GTiff",overwrite=TRUE)

writeRaster(predLC_crop_level1_2, filename="classified_reg2_lev3.tif", format="GTiff",overwrite=TRUE)
writeRaster(level1_reg2_prob_class1, filename="classified_prob_class1_reg2_lev3.tif", format="GTiff",overwrite=TRUE)
writeRaster(level1_reg2_prob_class2, filename="classified_prob_class2_reg2_lev3.tif", format="GTiff",overwrite=TRUE)
writeRaster(level1_reg2_prob_class3, filename="classified_prob_class3_reg2_lev3.tif", format="GTiff",overwrite=TRUE)

writeRaster(predLC_crop_level1_3, filename="classified_reg3_lev3.tif", format="GTiff",overwrite=TRUE)
writeRaster(level1_reg3_prob_class1, filename="classified_prob_class1_reg3_lev3.tif", format="GTiff",overwrite=TRUE)
writeRaster(level1_reg3_prob_class2, filename="classified_prob_class2_reg3_lev3.tif", format="GTiff",overwrite=TRUE)
writeRaster(level1_reg3_prob_class3, filename="classified_prob_class3_reg3_lev3.tif", format="GTiff",overwrite=TRUE)
