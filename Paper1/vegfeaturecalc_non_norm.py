...
for x in neighbors:
    ...
    compute_features(pc, x, target_idx_base, target, ['point_density','eigenv_1','eigenv_2','eigenv_3','z_entropy','std_z','var_z','skew_z','kurto_z','pulse_penetration_ratio','density_absolute_mean'], Cell(np.float(radius)))
