...
gdalbuildvrt mosaic.vrt *_eigenlargest.tif
gdal_translate -of GTiff mosaic.vrt mosaic_eigenlargest.tif

gdalbuildvrt mosaic.vrt *_eigenmedium.tif
gdal_translate -of GTiff mosaic.vrt mosaic_eigenmedium.tif

gdalbuildvrt mosaic.vrt *_eigensmallest.tif
gdal_translate -of GTiff mosaic.vrt mosaic_eigensmallest.tif
