...
:: import data
r.in.xyz --overwrite input=%filepath%%filename%.csv output=%filename%_lin separator=, skip=1 value_column=12
r.in.xyz --overwrite input=%filepath%%filename%.csv output=%filename%_plan separator=, skip=1 value_column=13
r.in.xyz --overwrite input=%filepath%%filename%.csv output=%filename%_sph separator=, skip=1 value_column=14
r.in.xyz --overwrite input=%filepath%%filename%.csv output=%filename%_omn separator=, skip=1 value_column=15
r.in.xyz --overwrite input=%filepath%%filename%.csv output=%filename%_ani separator=, skip=1 value_column=16
r.in.xyz --overwrite input=%filepath%%filename%.csv output=%filename%_eig separator=, skip=1 value_column=17
r.in.xyz --overwrite input=%filepath%%filename%.csv output=%filename%_sume separator=, skip=1 value_column=18
r.in.xyz --overwrite input=%filepath%%filename%.csv output=%filename%_curv separator=, skip=1 value_column=19
...
r.out.gdal --overwrite input=%filename%_eig output=%filepath%%filename%_eigenentropy.tif
r.out.gdal --overwrite input=%filename%_sume output=%filepath%%filename%_sumeigenvalues.tif
