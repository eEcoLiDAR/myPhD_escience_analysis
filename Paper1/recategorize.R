...
polygon@data$level3[polygon@data$StructDef=='W' | polygon@data$StructDef=='K' | polygon@data$StructDef=='P']="P"
...
polygon@data$level3[polygon@data$StructDef=='Gh' | polygon@data$StructDef=='Gl']="G"
...
polygon@data$level2[polygon@data$StructDef=='W' | polygon@data$StructDef=='K' | polygon@data$StructDef=='P']="P"
...
polygon@data$level2[polygon@data$StructDef=='Gh' | polygon@data$StructDef=='Gl']="G"
...
polygon@data$level1[polygon@data$StructDef=='W' | polygon@data$StructDef=='K' | polygon@data$StructDef=='P']="P"
...
polygon@data$level1[polygon@data$StructDef=='Rkd' | polygon@data$StructDef=='Rko' | polygon@data$StructDef=='Rld'
                    | polygon@data$StructDef=='Rlo' | polygon@data$StructDef=='Rwd' | polygon@data$StructDef=='Rwo'
                    | polygon@data$StructDef=='U' | polygon@data$StructDef=='Gh' | polygon@data$StructDef=='Gl'
...
rgdal::writeOGR(polygon, '.', 'recategorized2', 'ESRI Shapefile',overwrite_layer = TRUE)