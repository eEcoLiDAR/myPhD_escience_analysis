...
#B
rf.mod <- randomForest(x=featuretable_l1[ ,c(1:22)], y=featuretable_l1$B,importance = TRUE)
class(rf.mod)
varImpPlot(rf.mod)
...
#Bu
rf.mod <- randomForest(x=featuretable_l1[ ,c(1:22)], y=featuretable_l1$Bu,importance = TRUE)
class(rf.mod)
varImpPlot(rf.mod)
...
#G
rf.mod <- randomForest(x=featuretable_l1[ ,c(1:22)], y=featuretable_l1$G,importance = TRUE)
class(rf.mod)
varImpPlot(rf.mod)
...
#R
rf.mod <- randomForest(x=featuretable_l1[ ,c(1:22)], y=featuretable_l1$R,importance = TRUE)
class(rf.mod)
varImpPlot(rf.mod)
...
#S
rf.mod <- randomForest(x=featuretable_l1[ ,c(1:22)], y=featuretable_l1$S,importance = TRUE)
class(rf.mod)
varImpPlot(rf.mod)
